...
public class TestMinTx {
	...
	public void test001Remark() {
		...
		byte[] check = Base58Util.decode("L5Bo6bjUXMKSKMTKULAb6VTCN5Bzt5z8CN2ktNQHBRjZF33WCEbp");
		System.out.println(DatatypeConverter.printHexBinary(check));
		String check2 = Base58Util.encode(check);
